...
- [ ] [config] itch.io project page — set embed canvas dimensions. Current 1200×1000 too large; game canvas DOM is 640×512 plus UI/shop vertical chrome. Set embed width=720, height=680 (or measure live page and match). Also: un-draft when ready, confirm "This file will be played in the browser" toggle is on. Done in itch.io dashboard, no code change. (priority: low)
